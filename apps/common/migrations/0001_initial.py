...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('notification_type', models.CharField(choices=[('order', 'New Order'), ('booking', 'New Reservation'), ('review', 'New Review'), ('low_stock', 'Low Stock Alert'), ('system', 'System')], max_length=20)),
